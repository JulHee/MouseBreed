            ...
            <div id="MouseInfo" class="panel-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <p class="form-control-static">10Tage</p>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <div id="mid_content" class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                Jochbogenplatte und einem meist schlüssellochförmigen Unteraugenloch zum Durchtritt von Massetermuskel,
                ...
                Mäuseartige sind eher kleine Nagetiere.[2] Im Körperbau und in der Körperfunktion unterscheiden sie sich
                jedoch beträchtlich voneinander. Die Länge einschließlich Schwanz reicht von weniger als 100 Millimetern
                bei den Amerikanischen Zwergmäusen bis zu 800 Millimetern und mehr bei den Riesenborkenratten und den
                Riesenhamsterratten.[3] Letztere können ein Körpergewicht von 1,5 Kilogramm und die Bisamratte eins von
                1,8 Kilogramm erreichen. Der Schwanz ist meist dünn behaart und weist Hornschuppen auf.[4] Ebenso wie
                Ohren, Augen und Fell ist er jedoch in seinem Erscheinungsbild sehr variabel. Bei einigen Arten treten
                ...
                hinteres Keilbein, bt) Paukenblase, cl) Lambdaleiste, cnl) Capsula nasolacrimalis, co) Gelenkhöcker des
                Hinterhauptbeins, ct) Temporalleiste, f) Stirnbein, fhg) Foramen hypoglossi, fi) Schneidezahnloch, flm)
                Foramen lacerum medium, fm) großes Hinterhauptloch, fmp) Fossa mesopterygoidea, fo) Foramen ovale, foa)
                Foramen ovale accessorium, fpl) Gaumenloch, fpt) Flügelgrube des Keilbeins, ip) Zwischenscheitelbein, j)
                Jochbein, l) Tränenbein, m) Oberkiefer, ms) Warzenteil, n) Nasenbein, o) Hinterhauptbein, os) Flügel des
                vorderen Keilbeins, p) Scheitelbein, ph) Hakenfortsatz des Flügelbeins, pl) Gaumenbein, pm)
                Zwischenkieferbein, ppo) Processus paroccipitalis, pt) Flügelbein, pzm) Jochfortsatz des Oberkiefers,
                pzs) Jochfortsatz des Schuppenteils, s) Schuppenteil, spv) Keilbein-Gaumen-Loch, zn) Jochbogenkerbe, zp)
                ...
                Massetermuskels. Die Platte ist bei den meisten Mäuseartigen steil nach oben geneigt, weist bei einigen
                jedoch seitlich nach unten. Sie dehnt sich nicht nach vorne aus oder bildet einen ausgeprägten
                Jochbogendorn und eine Jochbogenkerbe aus. Das Unteraugenloch befindet sich hauptsächlich oberhalb der
                Jochbogenplatte und weist meist eine kennzeichnende Schlüssellochform auf. So ist der obere Teil als
                Durchtritt des mittleren Massetermuskels vergrößert. Der untere Teil für den Durchtritt der Nerven und
                Blutgefäße zur Schnauzenregion ist dagegen gewöhnlich schlitzartig verengt, kann jedoch fehlen. Die
                Schnauzenseite ist mittwärts der Jochbogenplatte ursprünglich verknöchert, bei den meisten Mäuseartigen
                jedoch gefenstert. Das Jochbein ist verkleinert, macht nur einen kleinen Bereich des Jochbogens aus und
                ...
                gewöhnlich auffällig, bei einigen Mäuseartigen jedoch sehr klein. Der Bereich zwischen den Augenhöhlen
                ist glatt und abgerundet oder verengt und mit scharfen Leisten. Der Hirnschädel ist glatt oder wird von
                einem Scheitelkamm oder Temporalleisten gekreuzt. Die Lambdaleiste ist bei einigen Mäuseartigen stark
                ausgeprägt, gewöhnlich jedoch unscheinbar. Das Schuppenteil ist ohne oder mit Postorbitalleiste. Über
                ...
                Öffnungen oder längliche Schlitze. Posterolaterale Gaumengruben fehlen oder sind vorhanden. Die Wände
                der Fossa mesopterygoidea sind verknöchert oder von Keilbein-Gaumen-Löchern durchbrochen. Die
                Flügelgruben des Keilbeins sind flach und tellerartig bis stark vertieft und gestaucht. Ihre Wände sind
                verknöchert oder löchrig. Ein Foramen stapediale ist ausgebildet oder fehlt. Manchmal wird es als
                knöcherne Röhre durch den Steigbügel fortgeführt. Das Foramen sphenofrontale und die damit verbundene
                Squamoso-Alisphenoid-Furche sind vorhanden oder fehlen. Der Canalis alisphenoidalis ist vorhanden aber
                kurz. Foramen masticatorium und Foramen buccinatorium sind eigenständig oder sekundär miteinander
                verschmolzen. In letzterem Fall sind sie vom Foramen ovale accessorium durch eine Strebe des hinteren
                ...
                außen gebogen und nie durchbrochen. Die Ansatzstelle des mittleren und seitlichen Massetermuskels ist
