...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 23. Jun 2015 um 13:05
...
CREATE TABLE IF NOT EXISTS `breed` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `finished_cage` (`finished_cage`)
...
(1, 10, '2015-03-04 23:00:00', '4', 'Mousehattan', 0, 0);
...
(1, 1, 1, 10, 0, NULL, 'Karl', 'AB', 200, NULL, NULL, NULL, 10, 0, ''),
(2, 1, 1, 10, 0, NULL, 'Paul', 'BA', 100, NULL, 3, 1, 5, 0, ''),
(3, 1, 1, 10, 1, NULL, 'Frauke', 'BB', 500, NULL, NULL, NULL, 5, 0, ''),
(4, 1, 1, 10, 1, NULL, 'Klara', 'AA', 1200, NULL, 3, 1, 80, 0, ''),
(5, 1, 1, 10, 0, NULL, 'Hans', 'AB', 500, NULL, 3, 1, 4, 0, ''),
(6, 1, 1, 10, 1, NULL, 'Berta', 'BB', 4000, NULL, 3, 1, 50, 0, '');
