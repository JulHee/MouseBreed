...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 06. Jul 2015 um 08:54
...
INSERT INTO `breed` (`id`, `user_id`, `time_of_creation`, `scenario`, `name`, `age`, `finished_cage`) VALUES
(1, 10, '2015-03-04 23:00:00', '1', 'Mousehattan', 0, 0);
...
--
ALTER TABLE `breed`
 ADD PRIMARY KEY (`id`), ADD KEY `user_id` (`user_id`), ADD KEY `finished_cage` (`finished_cage`);
