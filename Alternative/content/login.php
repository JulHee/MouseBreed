...
<div class="container">
	<form id="login_form" class="form-signin" action="http://local.mousebreed/home" method="post">
        ...
        <button id="login_button" class="btn btn-lg btn-success btn-block">Anmelden</button>
